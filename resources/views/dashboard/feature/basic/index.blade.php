    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">List All Data Basic</h1>
                ...
                <div class="flash-data-5" data-flashdata5="{{ Session::get('insert'); }}"></div>
                <div class="flash-data-6" data-flashdata6="{{ Session::get('update'); }}"></div>
                <div class="flash-data-7" data-flashdata7="{{ Session::get('delete'); }}"></div>

                <div class="row mb-4">
                    <div class="col-6">
                        <button class="btn btn-info" type="button" data-toggle="modal" data-target="#insertModal"><i class="fas fa-plus"></i> Tambah Data Basic</button>
                        <a href="/basic/active" style="text-decoration: none">
                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#"><i class="fas fa-check-circle"></i> Active</button>
                        </a>
                        <a href="/basic/non-active" style="text-decoration: none">
                ...
                <div class="card mb-4">
                    <div class="card-header"><i class="fas fa-table mr-1"></i>Table List All Data Basic</div>
                    <div class="card-body">
        ...
        <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="insertModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="insertModalLabel">Tambah Data Basic</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div>
                <div class="modal-body">
                <form action="/insert-basic" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="custom-file">
                        ...
                        <img class="img-thumbnail img-preview1 mt-2" src="{{ asset('storage/img-feature/basic/default-thumbnail.jpg') }}">
                    @error('cover')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        @foreach ($basic as $value)
            <div class="modal fade" id="updateModal{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Edit Data Basic</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form action="/update-basic" method="post" enctype="multipart/form-data">
                        @csrf
        ...
        @foreach ($basic as $value)
            <div class="modal fade" id="deleteModal{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Hapus Data Basic</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form action="/delete-basic" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" readonly id="id" name="id" value="{{ $value->id }}">
                        <p>
