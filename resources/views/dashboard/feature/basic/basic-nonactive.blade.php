    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">List Non-active Data Basic</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="dashboard-admin">Dashboard</a></li>
                    <li class="breadcrumb-item active">Features</li>
                    <li class="breadcrumb-item active">Basic</li>
                    <li class="breadcrumb-item active">Non-Active</li>
                </ol>
                ...
                <div class="row mb-4">
                    <div class="col-6">
                        ...
                        <a href="/basic" style="text-decoration: none">
                ...
                <div class="card mb-4">
                    <div class="card-header"><i class="fas fa-table mr-1"></i>Table List Non-active Data Basic</div>
                    <div class="card-body">
