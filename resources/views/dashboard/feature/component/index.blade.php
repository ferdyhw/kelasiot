    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">List All Data Component</h1>
                ...
                <div class="flash-data-14" data-flashdata14="{{ Session::get('insert'); }}"></div>
                <div class="flash-data-15" data-flashdata15="{{ Session::get('update'); }}"></div>
                <div class="flash-data-16" data-flashdata16="{{ Session::get('delete'); }}"></div>

                <div class="row mb-4">
                    <div class="col-7">
                        <button class="btn btn-info" type="button" data-toggle="modal" data-target="#insertModal"><i class="fas fa-plus"></i> Tambah Data Component</button>
                        <a href="/component/active" style="text-decoration: none">
                            <button class="btn btn-success" type="button" data-toggle="modal" data-target="#"><i class="fas fa-check-circle"></i> Active</button>
                        </a>
                        <a href="/component/non-active" style="text-decoration: none">
                ...
                <div class="card mb-4">
                    <div class="card-header"><i class="fas fa-table mr-1"></i>Table List All Data Component</div>
                    <div class="card-body">
                                    ...
                                    @foreach ($component as $value)
                                        <tr class="">
                                            ...
                                            <td>
                                                ...
                                                <a href="/component/gallery/{{ $value->id }}" style="text-decoration: none">
        ...
        <div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="insertModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <h5 class="modal-title" id="insertModalLabel">Tambah Data Component</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div>
                <div class="modal-body">
                <form action="/insert-component" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="custom-file">
                        ...
                        <img class="img-thumbnail img-preview1 mt-2" src="{{ asset('storage/img-feature/component/default-thumbnail.jpg') }}">
                    @error('cover')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        @foreach ($component as $value)
            <div class="modal fade" id="updateModal{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="updateModalLabel">Edit Data Component</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form action="/update-component" method="post" enctype="multipart/form-data">
                        @csrf
        ...
        @foreach ($component as $value)
            <div class="modal fade" id="deleteModal{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Hapus Data Component</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                    <form action="/delete-component" method="post">
                        @csrf
                        <input type="hidden" readonly id="id" name="id" value="{{ $value->id }}">
                        <p>
                            Yakin ingin menghapus data component dengan ID {{ $value->id }} ?
                        </p>
                    </div>
                    <div class="modal-footer">
