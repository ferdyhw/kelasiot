    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">List All Data Quiz</h1>
                ...
                <div class="flash-data-11" data-flashdata11="{{ Session::get('insert'); }}"></div>
                <div class="flash-data-12" data-flashdata12="{{ Session::get('update'); }}"></div>
                <div class="flash-data-13" data-flashdata13="{{ Session::get('delete'); }}"></div>
                ...
                <div class="card mb-4">
                    <div class="card-header"><i class="fas fa-table mr-1"></i>Table List All Data Quiz</div>
                    <div class="card-body">
                                    ...
                                    @foreach ($quiz as $value)
                                        <tr class="">
                                            ...
                                            <td>
                                                ...
                                                <a href="/quiz/question/{{ $value->id }}" style="text-decoration: none">
